export default function HomeFeatureOne() {
  return (
    <section className="px-5 xl:px-0 lg:max-w-[1175px] lg:mx-auto flex flex-col-reverse gap-[30px] justify-center font-WorkSans mt-[60px] items-center lg:flex-row-reverse lg:justify-between lg:gap-0">
